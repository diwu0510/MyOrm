...
{
    [MyTable("ApplicationRecords")]
    public class ApplicationRecord : IEntity
    {
        public ApplicationRecord()
        {
            CreateAt = DateTime.Now;
            ApplicationRecordLogs = new List<ApplicationRecordLog>();
        }
        ...
        public ICollection<ApplicationRecordLog> ApplicationRecordLogs { get; set; }
    }
}
